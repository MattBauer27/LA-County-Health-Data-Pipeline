...
fh = logging.FileHandler(f'Food_Retailers/RunLog/run_log.csv')
...
try:
    ...
    file_path_insp = 'Food_Retailers/Dates_txts/Inspections/last_update_inspections.txt'
    ...
    # Check if file exists and get the last update date
    file_path_loc = 'Food_Retailers/Dates_txts/Locations/last_update_locations.txt'
    ...
    if not last_recorded_dates_insp or last_update_date_insp > last_recorded_dates_insp[0]:
        ...
        new_records_df_insp.to_csv(
            f"Food_Retailers/Base_csvs/Inspections/food_retailers_insp_{last_update_date_insp}.csv", index=False, encoding='utf-8')
        if last_recorded_dates_insp:
            old_records_df_insp = pd.read_csv(
                f"Food_Retailers/Base_csvs/Inspections/food_retailers_insp_{last_recorded_dates_insp[0]}.csv", encoding='utf-8')
            ...
            df_added_insp.to_csv(
                f"Food_Retailers/Added/Inspections/food_retailers_insp_added_{last_update_date_insp}.csv", index=False, encoding='utf-8')
            ...
            df_dropped_insp.to_csv(
                f"Food_Retailers/Dropped/Inspections/food_retailers_insp_dropped_{last_update_date_insp}.csv", index=False, encoding='utf-8')
    ...
    if not last_recorded_dates_loc or last_update_date_loc > last_recorded_dates_loc[0]:
        ...
        new_records_df_loc.to_csv(
            f"Food_Retailers/Base_csvs/Locations/food_retailers_loc_{last_update_date_loc}.csv", index=False, encoding='utf-8')
        if last_recorded_dates_loc:
            old_records_df_loc = pd.read_csv(
                f"Food_Retailers/Base_csvs/Locations/food_retailers_loc_{last_recorded_dates_loc[0]}.csv", encoding='utf-8')
            ...
            df_added_loc.to_csv(
                f"Food_Retailers/Added/Locations/food_retailers_loc_added_{last_update_date_loc}.csv", index=False, encoding='utf-8')
            ...
            df_dropped_loc.to_csv(
                f"Food_Retailers/Dropped/Locations/food_retailers_loc_dropped_{last_update_date_loc}.csv", index=False, encoding='utf-8')
    ...
    if (not last_recorded_dates_insp or last_update_date_insp > last_recorded_dates_insp[0]) or (not last_recorded_dates_loc or last_update_date_loc > last_recorded_dates_loc[0]):
        ...
        # Check if file exists and get the last update date
        file_path_merged = 'Food_Retailers/Dates_txts/Combined/last_update_combined.txt'
        ...
        if not last_recorded_dates_merged or update_date > last_recorded_dates_merged[0]:
            ...
            merged_df.to_csv(
                f"Food_Retailers/Base_csvs/Combined/food_retailers_com_{update_date}.csv", index=False, encoding='utf-8')

            # If there are previous merged records
            if last_recorded_dates_merged:
                old_records_df_merged = pd.read_csv(
                    f"Food_Retailers/Base_csvs/Combined/food_retailers_com_{last_recorded_dates_merged[0]}.csv", encoding='utf-8')
                ...
                df_added_merged.to_csv(
                    f"Food_Retailers/Added/Combined/food_retailers_com_added_{update_date}.csv", index=False, encoding='utf-8')
                ...
                df_dropped_merged.to_csv(
                    f"Food_Retailers/Dropped/Combined/food_retailers_com_dropped_{update_date}.csv", index=False, encoding='utf-8')
                ...
                # Define CSV file
                csv_file = "Food_Retailers/Status_update/Status_updates.csv"
            ...
            feature_layer_name = "Food_Retailers_Inspection"
            ...
            df = pd.read_csv(
                f"Food_Retailers/Base_csvs/Combined/food_retailers_com_{update_date}.csv")
            ...
            if last_recorded_dates_merged:
                previous_geojson_file = f"Food_Retailers/Geocoded_geojson/Geocoded_Combined_{last_recorded_dates_merged[0]}.geojson"
            ...
            gdf.to_file(
                f"Food_Retailers/Geocoded_geojson/Geocoded_Combined_{update_date}.geojson", driver='GeoJSON')

            # Define the GeoJSON file path
            geojson_file = f"Food_Retailers/Geocoded_geojson/Geocoded_Combined_{update_date}.geojson"
