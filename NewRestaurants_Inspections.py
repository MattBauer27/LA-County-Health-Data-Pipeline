...
url = "https://services.arcgis.com/RmCCgQtiZLDCtblq/arcgis/rest/services/Public_Health_LOS_ANGELES_COUNTY_RESTAURANT_AND_MARKET_INSPECTIONS_/FeatureServer/0"
...
if not last_recorded_dates or last_update_date > last_recorded_dates[0]:
    ...
    query_url = "https://services.arcgis.com/RmCCgQtiZLDCtblq/arcgis/rest/services/Public_Health_LOS_ANGELES_COUNTY_RESTAURANT_AND_MARKET_INSPECTIONS_/FeatureServer/0/query"
    ...
    new_records_df['ACTIVITY_DATE'] = pd.to_datetime(
        new_records_df['ACTIVITY_DATE'], unit='ms')
